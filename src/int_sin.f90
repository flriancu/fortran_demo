...
module int_sin_module
   implicit none

   ! Everything in the module is private by default
   private

   ! Explicitly make some functions public for selective access
   public :: int_sin
